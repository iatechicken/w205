...
### Please refer to iatechicken-annotations.md for details on how to land the transformed messages to the hdfs

### Kafka topic name was "reviews" 

### Extracted "value" field from the dataset as separate dataframe
